import { Search, Home, Users, Package, Phone } from 'lucide-react'
      ...
      <div className="max-w-2xl w-full text-center space-y-8">
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 text-xs">
            <Link href="/artisans" className="text-amber-600 hover:text-amber-700 underline">
              Découvrir nos artisans
            </Link>
            <span className="text-gray-300">•</span>
            <Link href="/catalogue" className="text-amber-600 hover:text-amber-700 underline">
