...
<details>
  ...
  <ul>
    <li><a href="https://nextjs.org/">Nextjs.js</a></li>
  </ul>
</details>
...
```sh
  git clone git@github.com:Piercel2022/artisanat.git
```
...
```sh
  npx create-next-app@latest artisanat-francais
  cd artisanat-francais
```
...
- [ ] **[Module de Formation et Transmission]**
- [ ] **[Intelligence Artificielle de Recommandation]**
- [ ] **[Écosystème B2B et Certification]**
